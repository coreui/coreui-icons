...
import { cil3d } from './js/free/cil-3d.js'
import { cil4k } from './js/free/cil-4k.js'
import { cilAccountLogout } from './js/free/cil-account-logout.js'
import { cilActionRedo } from './js/free/cil-action-redo.js'
import { cilActionUndo } from './js/free/cil-action-undo.js'
import { cilAddressBook } from './js/free/cil-address-book.js'
import { cilAirplaneModeOff } from './js/free/cil-airplane-mode-off.js'
import { cilAirplaneMode } from './js/free/cil-airplane-mode.js'
import { cilAirplay } from './js/free/cil-airplay.js'
import { cilAlarm } from './js/free/cil-alarm.js'
import { cilAlbum } from './js/free/cil-album.js'
import { cilAlignCenter } from './js/free/cil-align-center.js'
import { cilAlignLeft } from './js/free/cil-align-left.js'
import { cilAlignRight } from './js/free/cil-align-right.js'
import { cilAmericanFootball } from './js/free/cil-american-football.js'
import { cilAnimal } from './js/free/cil-animal.js'
import { cilAperture } from './js/free/cil-aperture.js'
import { cilApple } from './js/free/cil-apple.js'
import { cilApplicationsSettings } from './js/free/cil-applications-settings.js'
import { cilApplications } from './js/free/cil-applications.js'
import { cilAppsSettings } from './js/free/cil-apps-settings.js'
import { cilApps } from './js/free/cil-apps.js'
import { cilArrowBottom } from './js/free/cil-arrow-bottom.js'
import { cilArrowCircleBottom } from './js/free/cil-arrow-circle-bottom.js'
import { cilArrowCircleLeft } from './js/free/cil-arrow-circle-left.js'
import { cilArrowCircleRight } from './js/free/cil-arrow-circle-right.js'
import { cilArrowCircleTop } from './js/free/cil-arrow-circle-top.js'
import { cilArrowLeft } from './js/free/cil-arrow-left.js'
import { cilArrowRight } from './js/free/cil-arrow-right.js'
import { cilArrowThickBottom } from './js/free/cil-arrow-thick-bottom.js'
import { cilArrowThickFromBottom } from './js/free/cil-arrow-thick-from-bottom.js'
import { cilArrowThickFromLeft } from './js/free/cil-arrow-thick-from-left.js'
import { cilArrowThickFromRight } from './js/free/cil-arrow-thick-from-right.js'
import { cilArrowThickFromTop } from './js/free/cil-arrow-thick-from-top.js'
import { cilArrowThickLeft } from './js/free/cil-arrow-thick-left.js'
import { cilArrowThickRight } from './js/free/cil-arrow-thick-right.js'
import { cilArrowThickToBottom } from './js/free/cil-arrow-thick-to-bottom.js'
import { cilArrowThickToLeft } from './js/free/cil-arrow-thick-to-left.js'
import { cilArrowThickToRight } from './js/free/cil-arrow-thick-to-right.js'
import { cilArrowThickToTop } from './js/free/cil-arrow-thick-to-top.js'
import { cilArrowThickTop } from './js/free/cil-arrow-thick-top.js'
import { cilArrowTop } from './js/free/cil-arrow-top.js'
import { cilAssistiveListeningSystem } from './js/free/cil-assistive-listening-system.js'
import { cilAsteriskCircle } from './js/free/cil-asterisk-circle.js'
import { cilAsterisk } from './js/free/cil-asterisk.js'
import { cilAt } from './js/free/cil-at.js'
import { cilAudioDescription } from './js/free/cil-audio-description.js'
import { cilAudioSpectrum } from './js/free/cil-audio-spectrum.js'
import { cilAudio } from './js/free/cil-audio.js'
import { cilAvTimer } from './js/free/cil-av-timer.js'
import { cilBabyCarriage } from './js/free/cil-baby-carriage.js'
import { cilBaby } from './js/free/cil-baby.js'
import { cilBackspace } from './js/free/cil-backspace.js'
import { cilBadge } from './js/free/cil-badge.js'
import { cilBalanceScale } from './js/free/cil-balance-scale.js'
import { cilBan } from './js/free/cil-ban.js'
import { cilBank } from './js/free/cil-bank.js'
import { cilBarChart } from './js/free/cil-bar-chart.js'
import { cilBarcode } from './js/free/cil-barcode.js'
import { cilBaseball } from './js/free/cil-baseball.js'
import { cilBasket } from './js/free/cil-basket.js'
import { cilBasketball } from './js/free/cil-basketball.js'
import { cilBath } from './js/free/cil-bath.js'
import { cilBathroom } from './js/free/cil-bathroom.js'
import { cilBattery0 } from './js/free/cil-battery-0.js'
import { cilBattery3 } from './js/free/cil-battery-3.js'
import { cilBattery5 } from './js/free/cil-battery-5.js'
import { cilBatteryAlert } from './js/free/cil-battery-alert.js'
import { cilBatteryEmpty } from './js/free/cil-battery-empty.js'
import { cilBatteryFull } from './js/free/cil-battery-full.js'
import { cilBatterySlash } from './js/free/cil-battery-slash.js'
import { cilBeachAccess } from './js/free/cil-beach-access.js'
import { cilBeaker } from './js/free/cil-beaker.js'
import { cilBed } from './js/free/cil-bed.js'
import { cilBellExclamation } from './js/free/cil-bell-exclamation.js'
import { cilBell } from './js/free/cil-bell.js'
import { cilBike } from './js/free/cil-bike.js'
import { cilBirthdayCake } from './js/free/cil-birthday-cake.js'
import { cilBlind } from './js/free/cil-blind.js'
import { cilBluetooth } from './js/free/cil-bluetooth.js'
import { cilBlurCircular } from './js/free/cil-blur-circular.js'
import { cilBlurLinear } from './js/free/cil-blur-linear.js'
import { cilBlur } from './js/free/cil-blur.js'
import { cilBoatAlt } from './js/free/cil-boat-alt.js'
import { cilBold } from './js/free/cil-bold.js'
import { cilBoltCircle } from './js/free/cil-bolt-circle.js'
import { cilBolt } from './js/free/cil-bolt.js'
import { cilBook } from './js/free/cil-book.js'
import { cilBookmark } from './js/free/cil-bookmark.js'
import { cilBorderAll } from './js/free/cil-border-all.js'
import { cilBorderBottom } from './js/free/cil-border-bottom.js'
import { cilBorderClear } from './js/free/cil-border-clear.js'
import { cilBorderHorizontal } from './js/free/cil-border-horizontal.js'
import { cilBorderInner } from './js/free/cil-border-inner.js'
import { cilBorderLeft } from './js/free/cil-border-left.js'
import { cilBorderOuter } from './js/free/cil-border-outer.js'
import { cilBorderRight } from './js/free/cil-border-right.js'
import { cilBorderStyle } from './js/free/cil-border-style.js'
import { cilBorderTop } from './js/free/cil-border-top.js'
import { cilBorderVertical } from './js/free/cil-border-vertical.js'
import { cilBowling } from './js/free/cil-bowling.js'
import { cilBraille } from './js/free/cil-braille.js'
import { cilBriefcase } from './js/free/cil-briefcase.js'
import { cilBrightness } from './js/free/cil-brightness.js'
import { cilBritishPound } from './js/free/cil-british-pound.js'
import { cilBrowser } from './js/free/cil-browser.js'
import { cilBrushAlt } from './js/free/cil-brush-alt.js'
import { cilBrush } from './js/free/cil-brush.js'
import { cilBug } from './js/free/cil-bug.js'
import { cilBuilding } from './js/free/cil-building.js'
import { cilBullhorn } from './js/free/cil-bullhorn.js'
import { cilBurger } from './js/free/cil-burger.js'
import { cilBurn } from './js/free/cil-burn.js'
import { cilBusAlt } from './js/free/cil-bus-alt.js'
import { cilCalculator } from './js/free/cil-calculator.js'
import { cilCalendarCheck } from './js/free/cil-calendar-check.js'
import { cilCalendar } from './js/free/cil-calendar.js'
import { cilCameraControl } from './js/free/cil-camera-control.js'
import { cilCameraRoll } from './js/free/cil-camera-roll.js'
import { cilCamera } from './js/free/cil-camera.js'
import { cilCarAlt } from './js/free/cil-car-alt.js'
import { cilCaretBottom } from './js/free/cil-caret-bottom.js'
import { cilCaretLeft } from './js/free/cil-caret-left.js'
import { cilCaretRight } from './js/free/cil-caret-right.js'
import { cilCaretTop } from './js/free/cil-caret-top.js'
import { cilCart } from './js/free/cil-cart.js'
import { cilCash } from './js/free/cil-cash.js'
import { cilCasino } from './js/free/cil-casino.js'
import { cilCast } from './js/free/cil-cast.js'
import { cilCat } from './js/free/cil-cat.js'
import { cilCc } from './js/free/cil-cc.js'
import { cilCenterFocus } from './js/free/cil-center-focus.js'
import { cilChartLine } from './js/free/cil-chart-line.js'
import { cilChartPie } from './js/free/cil-chart-pie.js'
import { cilChart } from './js/free/cil-chart.js'
import { cilChatBubble } from './js/free/cil-chat-bubble.js'
import { cilCheckAlt } from './js/free/cil-check-alt.js'
import { cilCheckCircle } from './js/free/cil-check-circle.js'
import { cilCheck } from './js/free/cil-check.js'
import { cilChevronBottom } from './js/free/cil-chevron-bottom.js'
import { cilChevronCircleDownAlt } from './js/free/cil-chevron-circle-down-alt.js'
import { cilChevronCircleLeftAlt } from './js/free/cil-chevron-circle-left-alt.js'
import { cilChevronCircleRightAlt } from './js/free/cil-chevron-circle-right-alt.js'
import { cilChevronCircleUpAlt } from './js/free/cil-chevron-circle-up-alt.js'
import { cilChevronDoubleDown } from './js/free/cil-chevron-double-down.js'
import { cilChevronDoubleLeft } from './js/free/cil-chevron-double-left.js'
import { cilChevronDoubleRight } from './js/free/cil-chevron-double-right.js'
import { cilChevronDoubleUp } from './js/free/cil-chevron-double-up.js'
import { cilChevronLeft } from './js/free/cil-chevron-left.js'
import { cilChevronRight } from './js/free/cil-chevron-right.js'
import { cilChevronTop } from './js/free/cil-chevron-top.js'
import { cilChildFriendly } from './js/free/cil-child-friendly.js'
import { cilChild } from './js/free/cil-child.js'
import { cilCircle } from './js/free/cil-circle.js'
import { cilClearAll } from './js/free/cil-clear-all.js'
import { cilClipboard } from './js/free/cil-clipboard.js'
import { cilClock } from './js/free/cil-clock.js'
import { cilClone } from './js/free/cil-clone.js'
import { cilClosedCaptioning } from './js/free/cil-closed-captioning.js'
import { cilCloudDownload } from './js/free/cil-cloud-download.js'
import { cilCloudUpload } from './js/free/cil-cloud-upload.js'
import { cilCloud } from './js/free/cil-cloud.js'
import { cilCloudy } from './js/free/cil-cloudy.js'
import { cilCode } from './js/free/cil-code.js'
import { cilCoffee } from './js/free/cil-coffee.js'
import { cilCog } from './js/free/cil-cog.js'
import { cilColorBorder } from './js/free/cil-color-border.js'
import { cilColorFill } from './js/free/cil-color-fill.js'
import { cilColorPalette } from './js/free/cil-color-palette.js'
import { cilColumns } from './js/free/cil-columns.js'
import { cilCommand } from './js/free/cil-command.js'
import { cilCommentBubble } from './js/free/cil-comment-bubble.js'
import { cilCommentSquare } from './js/free/cil-comment-square.js'
import { cilCompass } from './js/free/cil-compass.js'
import { cilCompress } from './js/free/cil-compress.js'
import { cilContact } from './js/free/cil-contact.js'
import { cilContrast } from './js/free/cil-contrast.js'
import { cilControl } from './js/free/cil-control.js'
import { cilCopy } from './js/free/cil-copy.js'
import { cilCouch } from './js/free/cil-couch.js'
import { cilCreditCard } from './js/free/cil-credit-card.js'
import { cilCropRotate } from './js/free/cil-crop-rotate.js'
import { cilCrop } from './js/free/cil-crop.js'
import { cilCursorMove } from './js/free/cil-cursor-move.js'
import { cilCursor } from './js/free/cil-cursor.js'
import { cilCut } from './js/free/cil-cut.js'
import { cilDataTransferDown } from './js/free/cil-data-transfer-down.js'
import { cilDataTransferUp } from './js/free/cil-data-transfer-up.js'
import { cilDeaf } from './js/free/cil-deaf.js'
import { cilDelete } from './js/free/cil-delete.js'
import { cilDescription } from './js/free/cil-description.js'
import { cilDevices } from './js/free/cil-devices.js'
import { cilDialpad } from './js/free/cil-dialpad.js'
import { cilDiamond } from './js/free/cil-diamond.js'
import { cilDinner } from './js/free/cil-dinner.js'
import { cilDisabled } from './js/free/cil-disabled.js'
import { cilDog } from './js/free/cil-dog.js'
import { cilDollar } from './js/free/cil-dollar.js'
import { cilDoor } from './js/free/cil-door.js'
import { cilDoubleQuoteSansLeft } from './js/free/cil-double-quote-sans-left.js'
import { cilDoubleQuoteSansRight } from './js/free/cil-double-quote-sans-right.js'
import { cilDrinkAlcohol } from './js/free/cil-drink-alcohol.js'
import { cilDrink } from './js/free/cil-drink.js'
import { cilDrop } from './js/free/cil-drop.js'
import { cilEco } from './js/free/cil-eco.js'
import { cilEducation } from './js/free/cil-education.js'
import { cilElevator } from './js/free/cil-elevator.js'
import { cilEnvelopeClosed } from './js/free/cil-envelope-closed.js'
import { cilEnvelopeLetter } from './js/free/cil-envelope-letter.js'
import { cilEnvelopeOpen } from './js/free/cil-envelope-open.js'
import { cilEqualizer } from './js/free/cil-equalizer.js'
import { cilEthernet } from './js/free/cil-ethernet.js'
import { cilEuro } from './js/free/cil-euro.js'
import { cilExcerpt } from './js/free/cil-excerpt.js'
import { cilExitToApp } from './js/free/cil-exit-to-app.js'
import { cilExpandDown } from './js/free/cil-expand-down.js'
import { cilExpandLeft } from './js/free/cil-expand-left.js'
import { cilExpandRight } from './js/free/cil-expand-right.js'
import { cilExpandUp } from './js/free/cil-expand-up.js'
import { cilExposure } from './js/free/cil-exposure.js'
import { cilExternalLink } from './js/free/cil-external-link.js'
import { cilEyedropper } from './js/free/cil-eyedropper.js'
import { cilFaceDead } from './js/free/cil-face-dead.js'
import { cilFace } from './js/free/cil-face.js'
import { cilFactorySlash } from './js/free/cil-factory-slash.js'
import { cilFactory } from './js/free/cil-factory.js'
import { cilFastfood } from './js/free/cil-fastfood.js'
import { cilFax } from './js/free/cil-fax.js'
import { cilFeaturedPlaylist } from './js/free/cil-featured-playlist.js'
import { cilFile } from './js/free/cil-file.js'
import { cilFilterFrames } from './js/free/cil-filter-frames.js'
import { cilFilterPhoto } from './js/free/cil-filter-photo.js'
import { cilFilterSquare } from './js/free/cil-filter-square.js'
import { cilFilterX } from './js/free/cil-filter-x.js'
import { cilFilter } from './js/free/cil-filter.js'
import { cilFindInPage } from './js/free/cil-find-in-page.js'
import { cilFingerprint } from './js/free/cil-fingerprint.js'
import { cilFire } from './js/free/cil-fire.js'
import { cilFlagAlt } from './js/free/cil-flag-alt.js'
import { cilFlightTakeoff } from './js/free/cil-flight-takeoff.js'
import { cilFlipToBack } from './js/free/cil-flip-to-back.js'
import { cilFlipToFront } from './js/free/cil-flip-to-front.js'
import { cilFlip } from './js/free/cil-flip.js'
import { cilFlower } from './js/free/cil-flower.js'
import { cilFolderOpen } from './js/free/cil-folder-open.js'
import { cilFolder } from './js/free/cil-folder.js'
import { cilFont } from './js/free/cil-font.js'
import { cilFootball } from './js/free/cil-football.js'
import { cilFork } from './js/free/cil-fork.js'
import { cilFridge } from './js/free/cil-fridge.js'
import { cilFrown } from './js/free/cil-frown.js'
import { cilFullscreenExit } from './js/free/cil-fullscreen-exit.js'
import { cilFullscreen } from './js/free/cil-fullscreen.js'
import { cilFunctionsAlt } from './js/free/cil-functions-alt.js'
import { cilFunctions } from './js/free/cil-functions.js'
import { cilGamepad } from './js/free/cil-gamepad.js'
import { cilGarage } from './js/free/cil-garage.js'
import { cilGem } from './js/free/cil-gem.js'
import { cilGif } from './js/free/cil-gif.js'
import { cilGift } from './js/free/cil-gift.js'
import { cilGlobeAlt } from './js/free/cil-globe-alt.js'
import { cilGolfAlt } from './js/free/cil-golf-alt.js'
import { cilGolf } from './js/free/cil-golf.js'
import { cilGradient } from './js/free/cil-gradient.js'
import { cilGrain } from './js/free/cil-grain.js'
import { cilGraph } from './js/free/cil-graph.js'
import { cilGridSlash } from './js/free/cil-grid-slash.js'
import { cilGrid } from './js/free/cil-grid.js'
import { cilGroup } from './js/free/cil-group.js'
import { cilHamburgerMenu } from './js/free/cil-hamburger-menu.js'
import { cilHandPointDown } from './js/free/cil-hand-point-down.js'
import { cilHandPointLeft } from './js/free/cil-hand-point-left.js'
import { cilHandPointRight } from './js/free/cil-hand-point-right.js'
import { cilHandPointUp } from './js/free/cil-hand-point-up.js'
import { cilHappy } from './js/free/cil-happy.js'
import { cilHd } from './js/free/cil-hd.js'
import { cilHdr } from './js/free/cil-hdr.js'
import { cilHeader } from './js/free/cil-header.js'
import { cilHeadphones } from './js/free/cil-headphones.js'
import { cilHealing } from './js/free/cil-healing.js'
import { cilHeart } from './js/free/cil-heart.js'
import { cilHighlighter } from './js/free/cil-highlighter.js'
import { cilHighligt } from './js/free/cil-highligt.js'
import { cilHistory } from './js/free/cil-history.js'
import { cilHome } from './js/free/cil-home.js'
import { cilHospital } from './js/free/cil-hospital.js'
import { cilHotTub } from './js/free/cil-hot-tub.js'
import { cilHouse } from './js/free/cil-house.js'
import { cilHttps } from './js/free/cil-https.js'
import { cilImageBroken } from './js/free/cil-image-broken.js'
import { cilImagePlus } from './js/free/cil-image-plus.js'
import { cilImage } from './js/free/cil-image.js'
import { cilInbox } from './js/free/cil-inbox.js'
import { cilIndentDecrease } from './js/free/cil-indent-decrease.js'
import { cilIndentIncrease } from './js/free/cil-indent-increase.js'
import { cilIndustrySlash } from './js/free/cil-industry-slash.js'
import { cilIndustry } from './js/free/cil-industry.js'
import { cilInfinity } from './js/free/cil-infinity.js'
import { cilInfo } from './js/free/cil-info.js'
import { cilInputHdmi } from './js/free/cil-input-hdmi.js'
import { cilInputPower } from './js/free/cil-input-power.js'
import { cilInput } from './js/free/cil-input.js'
import { cilInstitution } from './js/free/cil-institution.js'
import { cilItalic } from './js/free/cil-italic.js'
import { cilJustifyCenter } from './js/free/cil-justify-center.js'
import { cilJustifyLeft } from './js/free/cil-justify-left.js'
import { cilJustifyRight } from './js/free/cil-justify-right.js'
import { cilKeyboard } from './js/free/cil-keyboard.js'
import { cilLan } from './js/free/cil-lan.js'
import { cilLanguage } from './js/free/cil-language.js'
import { cilLaptop } from './js/free/cil-laptop.js'
import { cilLayers } from './js/free/cil-layers.js'
import { cilLeaf } from './js/free/cil-leaf.js'
import { cilLemon } from './js/free/cil-lemon.js'
import { cilLevelDown } from './js/free/cil-level-down.js'
import { cilLevelUp } from './js/free/cil-level-up.js'
import { cilLibraryAdd } from './js/free/cil-library-add.js'
import { cilLibraryBuilding } from './js/free/cil-library-building.js'
import { cilLibrary } from './js/free/cil-library.js'
import { cilLifeRing } from './js/free/cil-life-ring.js'
import { cilLightbulb } from './js/free/cil-lightbulb.js'
import { cilLineSpacing } from './js/free/cil-line-spacing.js'
import { cilLineStyle } from './js/free/cil-line-style.js'
import { cilLineWeight } from './js/free/cil-line-weight.js'
import { cilLinkAlt } from './js/free/cil-link-alt.js'
import { cilLinkBroken } from './js/free/cil-link-broken.js'
import { cilLink } from './js/free/cil-link.js'
import { cilListFilter } from './js/free/cil-list-filter.js'
import { cilListHighPriority } from './js/free/cil-list-high-priority.js'
import { cilListLowPriority } from './js/free/cil-list-low-priority.js'
import { cilListNumberedRtl } from './js/free/cil-list-numbered-rtl.js'
import { cilListNumbered } from './js/free/cil-list-numbered.js'
import { cilListRich } from './js/free/cil-list-rich.js'
import { cilList } from './js/free/cil-list.js'
import { cilLocationPin } from './js/free/cil-location-pin.js'
import { cilLockLocked } from './js/free/cil-lock-locked.js'
import { cilLockUnlocked } from './js/free/cil-lock-unlocked.js'
import { cilLocomotive } from './js/free/cil-locomotive.js'
import { cilLoop1 } from './js/free/cil-loop-1.js'
import { cilLoopCircular } from './js/free/cil-loop-circular.js'
import { cilLoop } from './js/free/cil-loop.js'
import { cilLowVision } from './js/free/cil-low-vision.js'
import { cilMagnifyingGlass } from './js/free/cil-magnifying-glass.js'
import { cilMap } from './js/free/cil-map.js'
import { cilMediaEject } from './js/free/cil-media-eject.js'
import { cilMediaPause } from './js/free/cil-media-pause.js'
import { cilMediaPlay } from './js/free/cil-media-play.js'
import { cilMediaRecord } from './js/free/cil-media-record.js'
import { cilMediaSkipBackward } from './js/free/cil-media-skip-backward.js'
import { cilMediaSkipForward } from './js/free/cil-media-skip-forward.js'
import { cilMediaStepBackward } from './js/free/cil-media-step-backward.js'
import { cilMediaStepForward } from './js/free/cil-media-step-forward.js'
import { cilMediaStop } from './js/free/cil-media-stop.js'
import { cilMedicalCross } from './js/free/cil-medical-cross.js'
import { cilMeh } from './js/free/cil-meh.js'
import { cilMemory } from './js/free/cil-memory.js'
import { cilMenu } from './js/free/cil-menu.js'
import { cilMic } from './js/free/cil-mic.js'
import { cilMicrophone } from './js/free/cil-microphone.js'
import { cilMinus } from './js/free/cil-minus.js'
import { cilMobileLandscape } from './js/free/cil-mobile-landscape.js'
import { cilMobile } from './js/free/cil-mobile.js'
import { cilMoney } from './js/free/cil-money.js'
import { cilMonitor } from './js/free/cil-monitor.js'
import { cilMoodBad } from './js/free/cil-mood-bad.js'
import { cilMoodGood } from './js/free/cil-mood-good.js'
import { cilMoodVeryBad } from './js/free/cil-mood-very-bad.js'
import { cilMoodVeryGood } from './js/free/cil-mood-very-good.js'
import { cilMoon } from './js/free/cil-moon.js'
import { cilMouse } from './js/free/cil-mouse.js'
import { cilMouthSlash } from './js/free/cil-mouth-slash.js'
import { cilMove } from './js/free/cil-move.js'
import { cilMovie } from './js/free/cil-movie.js'
import { cilMugTea } from './js/free/cil-mug-tea.js'
import { cilMug } from './js/free/cil-mug.js'
import { cilMusicNote } from './js/free/cil-music-note.js'
import { cilNewspaper } from './js/free/cil-newspaper.js'
import { cilNoteAdd } from './js/free/cil-note-add.js'
import { cilNotes } from './js/free/cil-notes.js'
import { cilObjectGroup } from './js/free/cil-object-group.js'
import { cilObjectUngroup } from './js/free/cil-object-ungroup.js'
import { cilOpacity } from './js/free/cil-opacity.js'
import { cilOpentype } from './js/free/cil-opentype.js'
import { cilOptions } from './js/free/cil-options.js'
import { cilPaintBucket } from './js/free/cil-paint-bucket.js'
import { cilPaint } from './js/free/cil-paint.js'
import { cilPaperPlane } from './js/free/cil-paper-plane.js'
import { cilPaperclip } from './js/free/cil-paperclip.js'
import { cilParagraph } from './js/free/cil-paragraph.js'
import { cilPaw } from './js/free/cil-paw.js'
import { cilPenAlt } from './js/free/cil-pen-alt.js'
import { cilPenNib } from './js/free/cil-pen-nib.js'
import { cilPen } from './js/free/cil-pen.js'
import { cilPencil } from './js/free/cil-pencil.js'
import { cilPeople } from './js/free/cil-people.js'
import { cilPhone } from './js/free/cil-phone.js'
import { cilPin } from './js/free/cil-pin.js'
import { cilPizza } from './js/free/cil-pizza.js'
import { cilPlant } from './js/free/cil-plant.js'
import { cilPlaylistAdd } from './js/free/cil-playlist-add.js'
import { cilPlus } from './js/free/cil-plus.js'
import { cilPool } from './js/free/cil-pool.js'
import { cilPowerStandby } from './js/free/cil-power-standby.js'
import { cilPregnant } from './js/free/cil-pregnant.js'
import { cilPrint } from './js/free/cil-print.js'
import { cilPushchair } from './js/free/cil-pushchair.js'
import { cilPuzzle } from './js/free/cil-puzzle.js'
import { cilQrCode } from './js/free/cil-qr-code.js'
import { cilRain } from './js/free/cil-rain.js'
import { cilRectangle } from './js/free/cil-rectangle.js'
import { cilRecycle } from './js/free/cil-recycle.js'
import { cilReload } from './js/free/cil-reload.js'
import { cilReportSlash } from './js/free/cil-report-slash.js'
import { cilResizeBoth } from './js/free/cil-resize-both.js'
import { cilResizeHeight } from './js/free/cil-resize-height.js'
import { cilResizeWidth } from './js/free/cil-resize-width.js'
import { cilRestaurant } from './js/free/cil-restaurant.js'
import { cilRoom } from './js/free/cil-room.js'
import { cilRouter } from './js/free/cil-router.js'
import { cilRowing } from './js/free/cil-rowing.js'
import { cilRss } from './js/free/cil-rss.js'
import { cilRuble } from './js/free/cil-ruble.js'
import { cilRunning } from './js/free/cil-running.js'
import { cilSad } from './js/free/cil-sad.js'
import { cilSatelite } from './js/free/cil-satelite.js'
import { cilSave } from './js/free/cil-save.js'
import { cilSchool } from './js/free/cil-school.js'
import { cilScreenDesktop } from './js/free/cil-screen-desktop.js'
import { cilScreenSmartphone } from './js/free/cil-screen-smartphone.js'
import { cilScrubber } from './js/free/cil-scrubber.js'
import { cilSearch } from './js/free/cil-search.js'
import { cilSend } from './js/free/cil-send.js'
import { cilSettings } from './js/free/cil-settings.js'
import { cilShareAll } from './js/free/cil-share-all.js'
import { cilShareAlt } from './js/free/cil-share-alt.js'
import { cilShareBoxed } from './js/free/cil-share-boxed.js'
import { cilShare } from './js/free/cil-share.js'
import { cilShieldAlt } from './js/free/cil-shield-alt.js'
import { cilShortText } from './js/free/cil-short-text.js'
import { cilShower } from './js/free/cil-shower.js'
import { cilSignLanguage } from './js/free/cil-sign-language.js'
import { cilSignalCellular0 } from './js/free/cil-signal-cellular-0.js'
import { cilSignalCellular3 } from './js/free/cil-signal-cellular-3.js'
import { cilSignalCellular4 } from './js/free/cil-signal-cellular-4.js'
import { cilSim } from './js/free/cil-sim.js'
import { cilSitemap } from './js/free/cil-sitemap.js'
import { cilSmilePlus } from './js/free/cil-smile-plus.js'
import { cilSmile } from './js/free/cil-smile.js'
import { cilSmokeFree } from './js/free/cil-smoke-free.js'
import { cilSmokeSlash } from './js/free/cil-smoke-slash.js'
import { cilSmoke } from './js/free/cil-smoke.js'
import { cilSmokingRoom } from './js/free/cil-smoking-room.js'
import { cilSnowflake } from './js/free/cil-snowflake.js'
import { cilSoccer } from './js/free/cil-soccer.js'
import { cilSofa } from './js/free/cil-sofa.js'
import { cilSortAlphaDown } from './js/free/cil-sort-alpha-down.js'
import { cilSortAlphaUp } from './js/free/cil-sort-alpha-up.js'
import { cilSortAscending } from './js/free/cil-sort-ascending.js'
import { cilSortDescending } from './js/free/cil-sort-descending.js'
import { cilSortNumericDown } from './js/free/cil-sort-numeric-down.js'
import { cilSortNumericUp } from './js/free/cil-sort-numeric-up.js'
import { cilSpa } from './js/free/cil-spa.js'
import { cilSpaceBar } from './js/free/cil-space-bar.js'
import { cilSpeak } from './js/free/cil-speak.js'
import { cilSpeaker } from './js/free/cil-speaker.js'
import { cilSpeech } from './js/free/cil-speech.js'
import { cilSpeedometer } from './js/free/cil-speedometer.js'
import { cilSpreadsheet } from './js/free/cil-spreadsheet.js'
import { cilSquare } from './js/free/cil-square.js'
import { cilStarHalf } from './js/free/cil-star-half.js'
import { cilStar } from './js/free/cil-star.js'
import { cilStorage } from './js/free/cil-storage.js'
import { cilStream } from './js/free/cil-stream.js'
import { cilStrikethrough } from './js/free/cil-strikethrough.js'
import { cilSun } from './js/free/cil-sun.js'
import { cilSwapHorizontal } from './js/free/cil-swap-horizontal.js'
import { cilSwapVertical } from './js/free/cil-swap-vertical.js'
import { cilSwimming } from './js/free/cil-swimming.js'
import { cilSync } from './js/free/cil-sync.js'
import { cilTablet } from './js/free/cil-tablet.js'
import { cilTag } from './js/free/cil-tag.js'
import { cilTags } from './js/free/cil-tags.js'
import { cilTask } from './js/free/cil-task.js'
import { cilTaxi } from './js/free/cil-taxi.js'
import { cilTennisBall } from './js/free/cil-tennis-ball.js'
import { cilTennis } from './js/free/cil-tennis.js'
import { cilTerminal } from './js/free/cil-terminal.js'
import { cilTerrain } from './js/free/cil-terrain.js'
import { cilTextShapes } from './js/free/cil-text-shapes.js'
import { cilTextSize } from './js/free/cil-text-size.js'
import { cilTextSquare } from './js/free/cil-text-square.js'
import { cilTextStrike } from './js/free/cil-text-strike.js'
import { cilText } from './js/free/cil-text.js'
import { cilThumbDown } from './js/free/cil-thumb-down.js'
import { cilThumbUp } from './js/free/cil-thumb-up.js'
import { cilToggleOff } from './js/free/cil-toggle-off.js'
import { cilToggleOn } from './js/free/cil-toggle-on.js'
import { cilToilet } from './js/free/cil-toilet.js'
import { cilTouchApp } from './js/free/cil-touch-app.js'
import { cilTransfer } from './js/free/cil-transfer.js'
import { cilTranslate } from './js/free/cil-translate.js'
import { cilTrash } from './js/free/cil-trash.js'
import { cilTriangle } from './js/free/cil-triangle.js'
import { cilTruck } from './js/free/cil-truck.js'
import { cilTv } from './js/free/cil-tv.js'
import { cilUnderline } from './js/free/cil-underline.js'
import { cilUsb } from './js/free/cil-usb.js'
import { cilUserFemale } from './js/free/cil-user-female.js'
import { cilUserFollow } from './js/free/cil-user-follow.js'
import { cilUserPlus } from './js/free/cil-user-plus.js'
import { cilUserUnfollow } from './js/free/cil-user-unfollow.js'
import { cilUserX } from './js/free/cil-user-x.js'
import { cilUser } from './js/free/cil-user.js'
import { cilVector } from './js/free/cil-vector.js'
import { cilVerticalAlignBottom } from './js/free/cil-vertical-align-bottom.js'
import { cilVerticalAlignCenter } from './js/free/cil-vertical-align-center.js'
import { cilVerticalAlignTop } from './js/free/cil-vertical-align-top.js'
import { cilVideo } from './js/free/cil-video.js'
import { cilVideogame } from './js/free/cil-videogame.js'
import { cilViewColumn } from './js/free/cil-view-column.js'
import { cilViewModule } from './js/free/cil-view-module.js'
import { cilViewQuilt } from './js/free/cil-view-quilt.js'
import { cilViewStream } from './js/free/cil-view-stream.js'
import { cilVoiceOverRecord } from './js/free/cil-voice-over-record.js'
import { cilVoice } from './js/free/cil-voice.js'
import { cilVolumeHigh } from './js/free/cil-volume-high.js'
import { cilVolumeLow } from './js/free/cil-volume-low.js'
import { cilVolumeOff } from './js/free/cil-volume-off.js'
import { cilWalk } from './js/free/cil-walk.js'
import { cilWallet } from './js/free/cil-wallet.js'
import { cilWallpaper } from './js/free/cil-wallpaper.js'
import { cilWarning } from './js/free/cil-warning.js'
import { cilWatch } from './js/free/cil-watch.js'
import { cilWc } from './js/free/cil-wc.js'
import { cilWeightlifitng } from './js/free/cil-weightlifitng.js'
import { cilWheelchair } from './js/free/cil-wheelchair.js'
import { cilWifiSignal0 } from './js/free/cil-wifi-signal-0.js'
import { cilWifiSignal1 } from './js/free/cil-wifi-signal-1.js'
import { cilWifiSignal2 } from './js/free/cil-wifi-signal-2.js'
import { cilWifiSignal3 } from './js/free/cil-wifi-signal-3.js'
import { cilWifiSignal4 } from './js/free/cil-wifi-signal-4.js'
import { cilWifiSignalOff } from './js/free/cil-wifi-signal-off.js'
import { cilWindowMaximize } from './js/free/cil-window-maximize.js'
import { cilWindowMinimize } from './js/free/cil-window-minimize.js'
import { cilWindowRestore } from './js/free/cil-window-restore.js'
import { cilWindow } from './js/free/cil-window.js'
import { cilWrapText } from './js/free/cil-wrap-text.js'
import { cilXCircle } from './js/free/cil-x-circle.js'
import { cilX } from './js/free/cil-x.js'
import { cilYen } from './js/free/cil-yen.js'
import { cilZoomIn } from './js/free/cil-zoom-in.js'
import { cilZoomOut } from './js/free/cil-zoom-out.js'
import { cilZoom } from './js/free/cil-zoom.js'
export { cil3d }
export { cil4k }
