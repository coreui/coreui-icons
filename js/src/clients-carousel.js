    ...
    var Gaps = {
      ...
      apply: function apply(slides) {
        for (var i = 0, len = slides.length; i < len; i++) {
          ...
          if (i !== 0) {
            style[MARGIN_TYPE[direction][0]] = '0px';
          } else {
            style[MARGIN_TYPE[direction][0]] = '';
          }

          if (i !== slides.length - 1) {
            style[MARGIN_TYPE[direction][1]] = '0px';
          } else {
...
var hexagonWidth = 216.73;
var mobileHegagonWidth = 89.06;
var currentVieportWidth = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);

new Glide('.c-customers-carousel',{
  type: 'carousel',
  autoplay: 1000,
  animationDuration: 1100,
  perView: Math.round(currentVieportWidth /hexagonWidth),
  breakpoints: {
    576: {
      perView: Math.round(576/mobileHegagonWidth)
    },
    768: {
      perView: Math.round(768/hexagonWidth)
    },
    992: {
      perView: Math.round(992/hexagonWidth)
    },
    1200: {
      perView: Math.round(1200/hexagonWidth)
    },
    1380: {
      perView: Math.round(1380/hexagonWidth)
    }
  }
}).mount()
