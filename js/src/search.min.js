...
toggleCategories()
updateIconsCounter()}
const toggleStyles=()=>{styles.forEach(input=>{input.checked===true?input.parentNode.classList.add('c-active'):input.parentNode.classList.remove('c-active')})}
const toggleTypes=()=>{types.forEach(input=>{input.checked===true?input.parentNode.classList.add('c-active'):input.parentNode.classList.remove('c-active')})}
